# The Suede Studio — Business Plan & Strategy

*Founders: Elva & Laura · Dublin, Ireland · v1 — July 2026*
*Internal document — contains pricing ranges and partnership terms. Not for clients.*

---

## 1. What we are

**The Suede Studio takes over ecommerce for small Irish businesses on Shopify — the store, the content, and the busywork — run by two people who do this for a living, powered by AI that never sleeps.**

The gap we fill: small businesses in Ireland currently choose between expensive agencies (€3k+ minimums, account managers, slow) or doing it all themselves (owner posting at 11pm, a Shopify store set up in a panic during Covid and never touched since). We're the middle that doesn't really exist yet: a personal studio that *runs* your ecommerce for you — and the differentiator is AI woven into everyday operations: product descriptions, customer-service drafts, reporting, the repetitive work that eats an owner's week.

**Positioning in one line:** *the AI-powered ecommerce studio for small businesses — we take over your Shopify store, your content, and your busywork.*
...
| Service | What's delivered | Typical effort | Lead |
|---|---|---|---|
| **Ecommerce management (Shopify)** | The core: we run the store — product pages, collections, checkout & shipping settings, apps, email capture, promotions, ongoing optimisation. Audits and setups as entry work. | Audit: 3–5 hrs · Setup: 20–35 hrs · Managed: 4–8 hrs/mo | Elva |
| **AI in everyday operations** | The differentiator: AI built into the client's routine — product-description drafting, customer-service reply drafts, review responses, weekly sales summaries, repetitive admin automated. Set up once, maintained monthly. | Setup: 6–12 hrs · Maintain: 1–2 hrs/mo | Elva |
| **Content creation & strategy** | Instagram/TikTok content made for the client — pillars, calendars, reels, carousels, captions, scheduling; or coaching the owner to run it | 4–8 hrs/month per retainer client | Laura |
| **Operations & brand support** | Back-office streamlining (order flow, returns process, supplier comms) plus brand starter kits: wordmark direction, palette, fonts, tone of voice, grid system | Ops: ongoing · Brand kit: 8–15 hrs | Laura |

Rule of thumb: **Elva owns "does it sell and does it run itself," Laura owns "does it look, sound and operate right."** Every deliverable gets a pass from both lenses.

**AI ground rules (protects the brand):** AI drafts, humans send. Every automation is shown to the client before it goes live; anything customer-facing gets a human approval step by default. We never present AI output as hand-made, and we keep a client-approved list of what may and may not be automated (captured in the intake questionnaire).
...
## 5. The partnership: equal time, split by domain

This is the section that keeps the business (and the friendship) alive. The constraint is real: Elva works full-time **and** is in college; Laura works full-time. So the model is built on equal *time*, honest *accounting*, and a pressure valve for bad weeks.

### The baseline: 6 hours a week, each

| Block | What | When |
|---|---|---|
| **2 hrs — joint session** (fixed, weekly, same evening) | Content batching for our own channels, pipeline review, decisions. This session is the business's heartbeat — it doesn't move except by agreement. | e.g. Sunday 7–9pm |
| **4 hrs — solo flexible** | Your domain work: client delivery, drafts, admin. Whenever suits your week. | your call |

Six hours is deliberately modest. It's sustainable through a college semester and a retail Christmas. The business scales *within* the budget (raise prices, better clients) before the budget itself grows.
...
## 6. Operations: lead → cash

One pipeline, one shared sheet, no tools we don't need.

1. **Lead arrives** (Instagram DM, email, referral) → logged in the shared pipeline sheet (name, business, source, date, owner).
...
**Days 1–30 — build the shopfront**
| Week | Milestones |
|---|---|
| 1 | Partnership one-pager signed. Business name registration filed (CRO). Instagram + TikTok handles claimed. Joint session scheduled as recurring. |
| 2 | Brand pack finalised (this repo). Domain bought, hello@ email live. |
| 3 | Website deployed (Netlify/GitHub Pages). Client questionnaire built in Google Forms (from `client-questionnaire.md`) and linked from the site. Pipeline sheet + time ledger created. |
| 4 | Two mock case studies made (audit + makeover of a fictional or consenting friend's shop) for the *glow-up* pillar. Content batch #1 in the can. |
...
*Review this document quarterly at a joint session. It should always describe the business you're actually running.*
